#ifndef __PARAM_XFS_DELETE_FOLDER_H
#define __PARAM_XFS_DELETE_FOLDER_H
...
public:
    CParam_XfsDeleteFolder();
    virtual ~CParam_XfsDeleteFolder();

    status_t InitBasic();
    status_t Init();
    status_t Destroy();

    status_t Copy(CParam_XfsDeleteFolder *_p);
    int Comp(CParam_XfsDeleteFolder *_p);
