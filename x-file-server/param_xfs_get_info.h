#ifndef __PARAM_XFS_GET_INFO_H
#define __PARAM_XFS_GET_INFO_H
...
public:
    CParam_XfsGetInfo();
    virtual ~CParam_XfsGetInfo();

    status_t InitBasic();
    status_t Init();
    status_t Destroy();

    status_t Copy(CParam_XfsGetInfo *_p);
    int Comp(CParam_XfsGetInfo *_p);
