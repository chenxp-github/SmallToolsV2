#ifndef __PARAM_XFS_DELETE_FILE_H
#define __PARAM_XFS_DELETE_FILE_H
...
public:
    CParam_XfsDeleteFile();
    virtual ~CParam_XfsDeleteFile();

    status_t InitBasic();
    status_t Init();
    status_t Destroy();

    status_t Copy(CParam_XfsDeleteFile *_p);
    int Comp(CParam_XfsDeleteFile *_p);
